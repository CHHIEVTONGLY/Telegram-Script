...
async def main():
    ...
    OPTIONS = {
        ...
        '18' : lambda: all_bot_update_firstname(bots , "change_name.csv"),
        '19': lambda: bots_forwards_to_saved(bots),
        '20': lambda: all_bot_removed_saved_messages(bots),
        '21': lambda: bots_leave_all_groups(bots),
    }
